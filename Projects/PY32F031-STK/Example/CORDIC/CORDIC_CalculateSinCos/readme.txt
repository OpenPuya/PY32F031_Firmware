...
使用步骤：
1. 编译并下载程序；
2. 程序运行后，观察打印的sin、cos值（sin(PI/6) = 1/2，cos(PI/6) = 0.866）

Example execution steps:
1. compile and download the program to MCU and run it;
2. After the program runs, observe the printed sin and cos values
   (sin (PI/6)=1/2, cos (PI/6)=0.866)
================================================================================
注意事项：
如果需要使用按键:
