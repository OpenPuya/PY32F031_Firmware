...
both the I2S master and I2S slave successfully receive the data, the LED will be 
constantly on. Otherwise, the LED will be blinking.
================================================================================
测试环境：
测试用板：PY32F031_STK
MDK版本： 5.28
...
2. 编译并下载主机程序 I2S_TwoBoard_CommunicationMaster_Polling。
3. 编译并下载从机程序 I2S_TwoBoard_CommunicationSlave_Polling。
...
2. Compile and download the master program I2S_TwoBoard_CommunicationMaster_Polling.
3. Compile and download the slave program I2S_TwoBoard_CommunicationSlave_Polling.
