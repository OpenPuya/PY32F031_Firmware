...
================================================================================
功能描述:
此样例是通过DMA方式对串口外设接口（SPI）与外部设备以全双工串行方式进行通信的演
...
communicating with an external device in full-duplex serial mode by DMA. 
...
2.编译下载主机程序SPI_TwoBoards_FullDuplexMaster_DMA_Init
...
1. Select two STK boards, one as the host and the other as the slave
2. Compile and download the host program SPI_TwoBoards_FullDuplexMaster_DMA_Init
3. Compile and download slave program: SPI_TwoBoards_FullDuplexSlave_DMA_Init
