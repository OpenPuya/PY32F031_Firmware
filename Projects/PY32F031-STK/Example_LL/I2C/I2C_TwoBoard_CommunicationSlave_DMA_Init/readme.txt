...
================================================================================
功能描述：
此样例演示了通过DMA方式进行I2C通讯。主机先向从机发送15字节的数据，然后再接收
...
device using I2C with DMA. The master device first sends 15 bytes of data to 
the slave device and then receives 15 bytes of data from the slave device. 
